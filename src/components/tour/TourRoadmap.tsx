...
const TourRoadmap: React.FC<TourRoadmapProps> = ({ tours = [] }) => {
  ...
  return (
    <div ref={ref} className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative py-10">
      {/* The vertical line */}
      <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-1 bg-royal-blue/20 -translate-x-1/2">
        <motion.div
          className="w-full h-full bg-gradient-to-b from-terracotta to-saffron-gold origin-top"
